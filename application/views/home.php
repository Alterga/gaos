...
<body class="text-light" style="background: #333 url('https://cdnhonda.azureedge.net/uploads/products/fitures/62637.png') center no-repeat;">

	<div class="container mt-5">

	<h2 class="mb-5 text-center">RENTAL MOTOR SUPRA</h2>
...
?>
	...
	<div class="form-group">
		<label for="kw">JENIS SUPRA</label>
		<input type="text" class="form-control" <?php echo $kw; ?> id="kw" name="keyword">
	</div>
	<div class="form-group">
		<label for="vol">JUMLAH MOTOR</label>
		<input type="text" class="form-control" <?php echo $vol; ?> id="vol" name="volume">
	</div>
	<div class="form-group">
		<label for="cpc">Harga</label>
